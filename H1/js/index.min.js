...
function(a) {
	...
	function e() {
		var b = document.getElementById("smohan-v4-music"),
			c = b.getAttribute("data-music-hash"),
			e = b.getAttribute("data-music-flag");
		return c && "N" != e ? (a.ajax({
			type: "GET",
			url: "http://www.smohan.net/api.php?apiname=song&method=getSong",
			data: {
				user: "014b2a89970b63bf097a5f64a4456a9b",
				hash: c
			},
			dataType: "jsonp",
			jsonp: "jsonpCallback",
			success: function(a) {
				200 == a.code && (a = a.data, a = {
					src: a.songUrl,
					cover: a.cover,
					title: a.title + " - " + a.singer
				}, s = document.createElement("audio"), s.src = "img/Dear friends-TRIPLANE.mp3", t.attr("title", "Dear Friends-TRIPLANE").find("img").attr("src", "img/music-wrap.jpg"), s ? (s.play(), s.loop = !0) : s.load(), d() ? t.removeClass("play").addClass("play-safari") : t.removeClass("play-safari").addClass("play"))
				//s = document.createElement("audio"), s.src = "http://7u2in2.com1.z0.glb.clouddn.com/I_Wanna_Be_Sedated.mp3", t.attr("title", "I Wanna Be Sedated - ramones").find("img").attr("src", "img/music-wrap.jpg"), s ? (s.play(), s.loop = !0) : s.load(), d() ? t.removeClass("play").addClass("play-safari") : t.removeClass("play-safari").addClass("play"))
			},
			error: function() {}
